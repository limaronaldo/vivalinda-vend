...
const Contact = ({ children, offset }) => (
  <>
    ...
    <Divider speed={0.1} offset={offset}>
      <UpDown>
        <SVG icon="butterfly" hiddenMobile width={8} fill={colors['grey-darkest']} left="70%" top="20%" />
        <SVG icon="butterfly" width={8} stroke={colors['grey-darkest']} left="25%" top="5%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="butterfly" width={12} stroke={colors.white} left="95%" top="50%" />
        <SVG icon="butterfly" width={6} fill={colors.white} left="85%" top="15%" />
